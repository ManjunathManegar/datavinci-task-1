  ...
  return (
    <div className="home">
      <div className="galery-section">
        ...
        <div className="desktop-thumbnails">
          {galleyImages.map((image) => (
            ...
            >
              <img
                className={`desktop-thumbnail ${image === galleyImages[currentIndex] ? 'opacity' : ''}`}
                src={image}
                alt="thumbnail"
              />
            </button>
      ...
      <div className="product-details-section">
            ...
            <Popup trigger={<MdInfoOutline size={18} />} position="bottom left">
              {(close) => (
                <div className="popup-container">
                  ...
                  <div className="card">
                    <p>
                      <strong>MGO </strong>is the key natural compound that
        ...
        <p className="tag-name gallery-mobile">Gallery</p>
        ...
        <div className="bundle-card">
          ...
          <div className="desktop-bundle-view">
            ...
            <button className="bundle-add-to-cart">Add bundle to cart </button>
          </div>
        </div>
